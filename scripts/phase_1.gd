...
func start():
	...
	yellowSkeleton.position =  $Entities/Player.global_position + Vector2(200, 30)
	...
	yellowSkeleton2.position =  $Entities/Player.global_position + Vector2(200, 30)
	...
	whiteSkeleton.position = $Entities/Player.global_position + Vector2(200, 30)
